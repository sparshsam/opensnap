...
public partial class AboutDialog : Window
{
    ...
    private void LoadChangelog()
    {
        try
        {
            ...
            // Try loading release notes from app directory first, then from repo
            var paths = new[]
            {
                Path.Combine(dir, "RELEASE_NOTES_v0.9.0.md"),
                Path.Combine(dir, "RELEASE_NOTES_v0.7.0.md"),
                Path.Combine(dir, "RELEASE_NOTES_v0.6.0.md"),
            };
